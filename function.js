...
const handleLoadCategory = async () => {
  ...
  data.data.forEach((category) => {
    ...
    div.innerHTML = `
      <a onclick="handleLoadMedia('${category.category_id}')" class="tab">${category.category}</a>
    `;
      ...
      <div class="card bg-base-100 shadow-xl">
        <div class="card-body ">
          ...
          <div class="flex gap-2">
            <div><img src="${media.authors[0].profile_picture}" class="rounded-full  w-9 h-9"/></div>
